  ...
  return (
    <div className="shrink-0 w-80 sm:w-84 glass-card glass-card-hover rounded-2xl p-6 flex flex-col justify-between border border-amber-500/20 bg-gradient-to-b from-amber-500/10 via-slate-900/50 to-slate-900/80 shadow-xl">
      ...
      <div className="flex items-center gap-2 mt-6 pt-4 border-t border-white/10">
        <button className="flex-1 bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 border border-emerald-500/30 font-semibold py-2 px-3 rounded-xl text-xs transition-all active:scale-95">
          ✓ Complete
        </button>
        <button className="flex-1 bg-rose-500/20 hover:bg-rose-500/30 text-rose-300 border border-rose-500/30 font-semibold py-2 px-3 rounded-xl text-xs transition-all active:scale-95">
          ✕ Fail
        </button>
      </div>
    </div>
