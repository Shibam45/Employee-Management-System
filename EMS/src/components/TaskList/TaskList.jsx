...
const TaskList = () => {
  return (
    <div className="mt-10 flex items-center justify-start gap-5 flex-nowrap h-[55%] overflow-x-auto w-full py-5">
        ...
        <div className="bg-amber-300 p-5 shrink-0 w-87 h-full  rounded-xl">
        ...
        <div className="bg-orange-500 p-5 shrink-0 w-87 h-full  rounded-xl">
        ...
        <div className="bg-lime-400 p-5 shrink-0 w-87 h-full  rounded-xl">
        ...
        <div className="bg-pink-400 p-5 shrink-0 w-87 h-full  rounded-xl">
